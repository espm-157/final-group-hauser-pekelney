...
Based on the [scientific literature](https://iopscience.iop.org/article/10.1088/2515-7620/ac17e2/pdf), forest ecologists have concluded that the reintroduction of wildfire reduces forest density and increases biodiversity through type conversion to shrubs and meadows in addition to mixed conifer forest. We wanted to examine this change by looking at NDVI values before and after the introduction of managed wildfire. [NDVI (Normalized Difference Vegetation Index)](https://www.usgs.gov/special-topics/remote-sensing-phenology/science/ndvi-foundation-remote-sensing-phenology) is a measure of relative greenness or vegetation health. Our hypothesis was that NDVI in the ICB would have decreased overtime after the introduction of managed wildfire due to this type conversion. 
...
yos_fires %>% 
  ...
  geom_vline(aes(xintercept=1972), color="purple", linetype="dotted")
```
While the earliest year on record in this dataset is 1933, it is important to note that the period of fire suppression extended further back into the mid 19th century. 
...
Upon visual inspection, the NDVI in 1972 seems lower than in 2021. To better understand this difference and to assess if there was a change in NDVI, we plotted the distribution of NDVI values across the ICB for both years and overlaid them on a single chart:
...
mean_21 = mean(df_21$LC08_L1TP_042034_20210915_20210925_02_T1_B5)
mean_72 = mean(df_72$LM01_L1TP_045034_19720916_20200909_02_T2_B7)

# comparing median NDVI in ICB in 1972 vs 2021
med_21 = median(df_21$LC08_L1TP_042034_20210915_20210925_02_T1_B5)
med_72 = median(df_72$LM01_L1TP_045034_19720916_20200909_02_T2_B7)

print(paste("Mean NDVI in ICB in 1972:", mean_72))
print(paste("Mean NDVI in ICB in 2021:", mean_21))

print(paste("Median NDVI in ICB in 1972:", med_72))
print(paste("Median NDVI in ICB in 2021:", med_21))
```
