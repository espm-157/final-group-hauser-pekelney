...
```{r}
# fire perimeters have been re-projected to CRS: WGS 84 / UTM Zone 10N
fireperimetersCA = as.tibble(fireperimeters) 
...
yos_fires %>% 
  ...
  ggplot(aes(x=Year, y=n)) + geom_point(color="red", alpha=0.5) +
  labs(y = "Number of Fires", title = "Number of Fires in Yosemite per Year since 1972")
