...
Overview of fire as an ecological process and indigenous fire use
...
First we examined [historical fire data](https://frap.fire.ca.gov/frap-projects/fire-perimeters/) for Yosemite National Park as a whole to contextualize the change in fire patterns after 1972. 
...
yos_fires %>% 
  ...
  geom_vline(aes(xintercept=1972), color="purple", linetype="dotted")
```
Another way to represent the change in fire patterns after the introduction of managed wildfire is through 
