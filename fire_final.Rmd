...
landsat_raster_refl <- rast("LC08_L1TP_042034_20210611_20210622_02_T1_refl.tif")
landsat_raster_tir <- rast("LC08_L1TP_042034_20210611_20210622_02_T1_tir.tif")
landsat_raster_qb <- rast("LC08_L1TP_042034_20210611_20210622_02_T1_qb.tif")

rast_merge <- raster::merge(landsat_raster_refl, landsat_raster_tir)

landsat_multispectral_st <- stack(rast_merge)
landsat_multispectral_br <- brick(landsat_multispectral_st)

landsat_ndvi <- (landsat_multispectral_br[[5]] - landsat_multispectral_br[[4]]) / (landsat_multispectral_br[[5]] + landsat_multispectral_br[[4]])
